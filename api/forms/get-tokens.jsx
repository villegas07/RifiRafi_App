...
/**
 * @typedef {'id'|'expirationDate'|'isBlacklisted'|'createdAt'|'updatedAt'} FormTokenOrderBy
 */

/**
 * @typedef {Object} GetAllFormTokensParams
 * @property {SortOrder} [order='ASC'] - The order of the tokens.
 * @property {FormTokenOrderBy} [orderBy='createdAt'] - The field to order by.
 * @property {number} [page=1] - Page number.
 * @property {number} [limit=10] - Tokens per page.
 */
